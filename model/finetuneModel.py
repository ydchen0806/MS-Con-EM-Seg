...
class pretrainModel(nn.Module):
    def __init__(self, cfg):
        ...
        if self.cfg.MODEL.model_type == 'mala':
            ...
            self.model = UNet3D_MALA(output_nc=self.cfg.MODEL.output_nc, if_sigmoid=self.cfg.MODEL.if_sigmoid, init_mode=self.cfg.MODEL.init_mode_mala, show_feature=True)
        elif self.cfg.MODEL.model_type == 'superhuman':
            print('load superhuman model without skip!')
            self.model = UNet_PNI(in_planes=self.cfg.MODEL.input_nc,
