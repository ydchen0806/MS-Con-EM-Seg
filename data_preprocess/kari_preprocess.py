...
if __name__ == '__main__':
    K_path = '/braindat/large-scale-EM-data/Kasthuri2015/Thousands_6nm_spec_lossless'
    ...
    for i in tqdm(range(len(K_list_middle))):
        ...
        for j in range(num):
            ...
            if k == 99:
                for l in range(16):
                    save_h5(temp_hdf[l], save_path, save_name + str(i) + '_' + str(l) + '.hdf')
                k = 0
        k += 1
